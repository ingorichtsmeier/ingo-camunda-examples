package com.camunda.consulting.terminateSubprocesses;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "terminate-subprocesses";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "terminate-subprocesses.war")
            ...
            .addPackages(false, "com.camunda.consulting.terminateSubprocesses") // not recursive to skip package 'nonarquillian'
