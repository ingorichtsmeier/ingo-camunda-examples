...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/failing-job-example/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/failing-job-example">Camunda BPM Process Application</a></td>
