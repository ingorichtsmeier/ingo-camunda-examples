...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "failing-job-example";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "failing-job-example.war")
            ...
            .addPackages(false, "com.camunda.consulting.failing_job_example") // not recursive to skip package 'nonarquillian'
