package com.camunda.consulting.jaxEndpointExample;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "jax-endpoint-example";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "jax-endpoint-example.war")
            ...
            .addPackages(false, "com.camunda.consulting.jaxEndpointExample") // not recursive to skip package 'nonarquillian'
