...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "receive-call-activity";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "receive-call-activity.war")
            ...
            .addPackages(false, "com.camunda.consulting.swisslife.receiveCallActivity") // not recursive to skip package 'nonarquillian'
