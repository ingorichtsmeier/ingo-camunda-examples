...
<!-- HTML snippet for index page
  <tr>
    <td><img src="snippets/gregXMLCalendarJson/src/main/resources/process.png" width="100"></td>
    <td><a href="snippets/gregXMLCalendarJson">Camunda BPM Process Application</a></td>
