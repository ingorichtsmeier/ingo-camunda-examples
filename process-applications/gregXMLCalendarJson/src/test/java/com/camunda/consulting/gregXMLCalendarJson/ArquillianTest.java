...
public class ArquillianTest {
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "gregXMLCalendarJson.war")
            ...
            .addPackages(false, "com.camunda.consulting.gregXMLCalendarJson") // not recursive to skip package 'nonarquillian'
