...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "message-exchange";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "message-exchange.war")
            ...
            .addPackages(false, "org.camunda.consulting.message_exchange") // not recursive to skip package 'nonarquillian'
