...
public class ArquillianTest {
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "muliinstance-call-activity.war")
            ...
            .addPackages(false, "com.camunda.consulting.multiinstanceCallActivity") // not recursive to skip package 'nonarquillian'
