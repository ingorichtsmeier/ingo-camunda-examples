package com.camunda.consulting.correlate_message_question;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "correlate-message-question";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "correlate-message-question.war")
            ...
            .addPackages(false, "com.camunda.consulting.correlate_message_question") // not recursive to skip package 'nonarquillian'
