...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "javascript-validation";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "javascript-validation.war")
            ...
            .addPackages(false, "com.camunda.consulting.javascriptValidation") // not recursive to skip package 'nonarquillian'
