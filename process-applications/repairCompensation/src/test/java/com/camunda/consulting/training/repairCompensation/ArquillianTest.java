package com.camunda.consulting.training.repairCompensation;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "repairCompensation";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "repairCompensation.war")
            ...
            .addPackages(false, "com.camunda.consulting.training.repairCompensation") // not recursive to skip package 'nonarquillian'
